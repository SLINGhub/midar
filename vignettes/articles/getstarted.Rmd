...
data_path <- system.file("extdata", "MRMkit_demo.tsv", package = "midar")
...
myexp <- analyses_to_exclude(myexp, analyses_to_exclude = analyses_to_exlude = c("Longit_batch6_51"), replace_existing  = TRUE)
