...
While `MiDAR`'s core functionality does not require any R coding skills, a basic
understanding of R and an R IDE is needed. If you are new to R, you can familiarize yourself
through online tutorials such a
...
having a colleague who is familiar with RStudio assist you can be very helpful
to get started smoothly and stay motivated.

# Installation of `MiDAR`
...
# Using MiDAR via Recipes and Manual
