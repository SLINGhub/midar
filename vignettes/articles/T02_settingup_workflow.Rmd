...
As introduced in [Preparing and Import Data and Metadata](articles/T01_prepdata.html)  
...
described in [Preparing and Import Data and Metadata](articles/T01_prepdata.html).
To keep the code concience in this example, we will import metadata from an MSOrganizer
